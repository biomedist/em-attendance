...
import { saveAttendance, addStudent, removeStudent } from "@/app/actions";
          ...
          <li key={student.id} className="rounded-xl bg-white p-3 shadow-sm ring-1 ring-stone-200/60">
            <div className="mb-2.5 flex items-center gap-3">
              ...
              <button
                ...
                className="shrink-0 rounded-lg px-2 py-1 text-xs text-red-400 hover:bg-red-50 hover:text-red-600"
              >
                Remove
              </button>
            </div>
