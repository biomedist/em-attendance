...
const NAV_ITEMS = [
  {
    href: "/",
    label: "Groups",
    match: (path: string) => path === "/" || path.startsWith("/groups"),
    icon: (
  ...
  },
  {
    href: "/offering",
    label: "Offering",
    match: (path: string) => path.startsWith("/offering"),
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor">
  ...
  },
  {
    href: "/notice",
    label: "Notice",
    match: (path: string) => path.startsWith("/notice"),
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor">
      ...
      <div className="mx-auto flex max-w-lg">
        {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              <span className={isActive ? "text-amber-600" : ""}>
                {item.icon}
              </span>
